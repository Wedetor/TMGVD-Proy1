...
int main() {
	...
	map<unsigned int, unsigned int> GenA = hyperloglog("GCF_000331305.1_ASM33130v1_genomic.fna", seed);
	map<unsigned int, unsigned int> GenB = hyperloglog("GCF_000959725.1_ASM95972v1_genomic.fna", seed);
